#!/usr/bin/env python3
"""
Original AES-128 implementation at 
https://github.com/bozhu/AES-Python.
This implementation is also helped by @boppreh
...
class AES_M:
    ...
    def __init__(self):
        ...
        """
        master_key=b"YXUCYRDVYXUCYRDV"
        assert len(master_key) in AES_M.rounds_by_key_size
        self.n_rounds = AES_M.rounds_by_key_size[len(master_key)]
    ...
    def encrypt_ctr(self, plaintext):
        ...
        """
        assert len(b'YXUCYRDVYXUCYRDV') == 16

        blocks = []
        nonce = b'YXUCYRDVYXUCYRDV'
    ...
    def encrypt(self, file_name):
        ...
        with open(file_name, 'rb') as fo:
            plaintext = fo.read()
        enc = self.encrypt_ctr(plaintext)
    ...
    def decrypt(self, file_name):
        ...
        with open(file_name, 'rb') as fo:
            ciphertext = fo.read()
        dec = self.decrypt_ctr(ciphertext)
